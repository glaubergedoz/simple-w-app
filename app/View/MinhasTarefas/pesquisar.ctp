            ...
            <section class="col-lg-12 connectedSortable">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <ul class="todo-list" data-url="<?php echo $_SERVER["HTTP_REFERER"]; ?>/minhas_tarefas/ordenar">
                                    ...
                                    <li class="<?php if($tarefa->Tarefa->situacao_id==2) { echo 'bg-checked'; } else { echo 'situacao_feita'; } ?>"  data-id="<?php echo $tarefa->Tarefa->id; ?>">
                                        ...
                                        ?>
                                            ...
                                            <input class="pointer btn-status btn-salvar"
                                                   ...
                                                   data-url="<?php echo $_SERVER["HTTP_REFERER"]; ?>/minhas_tarefas/concluir/<?php echo $tarefa->Tarefa->id; ?>">

                                        <?php
                                        }
                                        ?>

                                        <a href="<?php echo $_SERVER["HTTP_REFERER"]; ?>/minhas_tarefas/mostrar/<?php echo $tarefa->Tarefa->id; ?>">
                                        ...
                                        <div class="tools">
                                            ...
                                            <a class="tools-a"
                                               href="<?php echo $_SERVER["HTTP_REFERER"]; ?>/minhas_tarefas/mostrar/<?php echo $tarefa->Tarefa->id; ?>">
                                                <i class="fa fa-info"></i>
                                            </a>

                                            <a class="tools-a"
                                               href="<?php echo $_SERVER["HTTP_REFERER"]; ?>/minhas_tarefas/alterar/<?php echo $tarefa->Tarefa->id; ?>">
                                                <i class="fa fa-edit"></i>
                                            </a>

                                            <a class="btn-salvar"
                                               href="<?php echo $_SERVER["HTTP_REFERER"]; ?>/minhas_tarefas/excluir/<?php echo $tarefa->Tarefa->id; ?>">
